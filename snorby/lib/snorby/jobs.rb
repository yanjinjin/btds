...
require 'snorby/jobs/sys_status_job'
...
module Snorby
  ...
  module Jobs
    ...
    def self.sys_status
      Snorby::Jobs.find.first(:handler.like => "%!ruby/struct:Snorby::Jobs::SysStatusJob%")
    end 
    ...
    def self.sys_status?
      !Snorby::Jobs.find.first(:handler.like => "%!ruby/struct:Snorby::Jobs::SysStatusJob%").blank?
    end  
